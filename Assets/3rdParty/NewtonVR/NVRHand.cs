...
namespace NewtonVR
{
    public class NVRHand : MonoBehaviour
    {
        ...
        private NVRPhysicalController PhysicalController;//xw: 
        ...
        public bool IsHovering
        {
            get
            {
                return CurrentlyHoveringOver.Any(kvp => kvp.Value.Count > 0);//xw: 
            }
        }
        ...
        protected virtual void Awake()
        {
            ...
            SteamVR_Utils.Event.Listen("render_model_loaded", RenderModelLoaded);//xw: 
        }
        ...
        //Trigger的三个函数只是管理CurrentlyHoveringOver的值，值得改变带来的变化在Update中
